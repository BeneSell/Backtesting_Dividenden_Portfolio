...
def main():
    ...
    while True:
        ...
        print("2a: Download data from Financial Modeling Prep from Local Folder")
        ...
        print("6: Generate visualizations from preproccessed data")
        print("6a: Generate alpha vantage stock diagram")
        print("6b: Generate alpha vantage dividend diagram")
        print("6c: Generate alpha vantage stock as candlestick")
        print("6d: Generate fmp dividend diagram")
        print("6e: Generate fmp stock diagram")
        print("6f: Generate combined fmp vs alpha dividend diagram")
...
def test_strategie_data_interface():
    ...
    """
    pytest.main(["-v", file_names["basic_paths"]["test_path"] + file_names["file_names"]["test_strategie_data_interface"]])

def test_strategie_calc_indikator():
    """
    This function is used to test the strategie_calc_indikator.py file
    """
    pytest.main(["-v", file_names["basic_paths"]["test_path"] + file_names["file_names"]["test_strategie_calc_indikator"]])
